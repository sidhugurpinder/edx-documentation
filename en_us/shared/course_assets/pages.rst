...
By default, the system adds these pages to every course.
...
.. image:: ../../../shared/images/page_bar_lms_orig.png
 :width: 600
 :alt: The navigation bar in the LMS with all of the default options.

In addition, the system adds pages for each :ref:`textbook <Adding Textbooks>`
that you add to the course. If you enable the :ref:`notes tool <Notes Tool>`
for your course, the system adds a **Notes** page.

To customize your course, you can make the following changes to the default
pages.
...
example, the pages in a course that includes a textbook named **Introduction to
Music Theory** as well as pages for **Course Schedule** and **Supplements**
appears as follows.

.. image:: ../../../shared/images/page_bar_lms.png
 :width: 800
 :alt: Image of the navigation bar in the LMS with the default pages, a textbook page, and two additional pages.

You can add pages to your course for the course syllabus, FAQ, or any other
content. When you add a page, you also add its content.
...
#. To provide a different name for the page, select **Settings**, and then
   enter a  **Display Name**. The display name is the name of the page visible
   to learners in the course.
...
:ref:`reorganize the course outline<Reorganize the Course Outline>`, by
dragging a page to different location in the list of pages and dropping it
there.
