...
In addition, see the following topics about other aspects of open response
assessments.
...
assignment, course team members see a **Grade Available Responses** option at
the end of the assignment in the course, and learners see a **Staff
Assessment** step in their assignment.

Submitting a staff assessment has the following results.

* The grade for the assessment that you submit overrides scores previously
  calculated from other assessment types in the assignment.

* Peer assessments performed on this response after a staff grade has been
  given have no effect on the learner's final assignment grade.

.. note:: The score that you give a learner in a staff assessment step
   overrides scores from any other assessment type in the assignment, including
   any peer assessments that are completed after your staff assessment.
